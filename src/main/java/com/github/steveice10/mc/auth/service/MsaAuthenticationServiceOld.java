...
public class MsaAuthenticationServiceOld extends AuthenticationService {
    /**
     ...
     */
    public MsaAuthenticationServiceOld(String clientId) throws IOException {
     ...
     */
    public MsaAuthenticationServiceOld(String clientId, MSALApplicationOptions msalOptions) throws MalformedURLException {
     ...
     */
    public MsaAuthenticationServiceOld(String clientId, Set<String> scopes, PublicClientApplication app) {
        super(URI.create(""));
